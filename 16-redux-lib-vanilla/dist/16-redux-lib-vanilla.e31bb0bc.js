...
var btnDecrease = document.querySelector('#decrease'); // 액션에 이름 정의

var TOGGLE_SWITCH = 'TOGGLE_SWITCH';
var INCREASE = 'INCREASE';
var DECREASE = 'DECREASE'; //액션 생성 함수 camel notation
...
var render = function render() {
  ...
  var state = store.getState(); // 현재상태 호출
...
render(); // 구독하기 (상태가 바뀔때마다 render 함수를 호출)

store.subscribe(render); // 액션 발생 함수
...
//# sourceMappingURL=/16-redux-lib-vanilla.e31bb0bc.js.map